...
INPUTS = ['data/input_for_cnn_star_w_psfs.h5', 'data/single_point_psf_for_cnn.h5', 'data/input_for_cnn_psf_NA.h5']
#'cnn_output_star.h5'
OUTPUTS = ['data/cnn_output_star.h5', 'data/cnn_output_single_psf.h5',  'data/cnn_output_psf_NA.h5']
